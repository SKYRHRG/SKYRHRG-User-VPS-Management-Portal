 ...
 *
 * Admin Panel Navbar (Updated Design)
 */
?>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link d-flex align-items-center" data-bs-toggle="dropdown" href="#">
                <img src="https://placehold.co/160x160/007bff/ffffff?text=A" class="img-circle elevation-1" alt="User Image" style="width: 25px; height: 25px; object-fit: cover; margin-right: 8px;">
