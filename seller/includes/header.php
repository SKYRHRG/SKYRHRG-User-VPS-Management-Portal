...
// Authorize access: 'seller', 'super_seller', and 'admin' roles are allowed
authorize_access(['seller', 'super_seller', 'admin']);

// A dynamic page title can be set before including this header
$page_title = isset($page_title) ? $page_title : 'Seller Dashboard';
?>
<!DOCTYPE html>
<html lang="en">
<head>
